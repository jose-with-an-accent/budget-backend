...
var FileTypes;
(function (FileTypes) {
    FileTypes[FileTypes["JSON"] = 0] = "JSON";
    FileTypes[FileTypes["CSV"] = 1] = "CSV";
})(FileTypes || (FileTypes = {}));
var FileSyncService = /** @class */ (function () {
    function FileSyncService() {
    }
    FileSyncService.fromFile = function (filePath) {
        var _this = this;
        var transactions = [];
...
exports["default"] = FileSyncService;
